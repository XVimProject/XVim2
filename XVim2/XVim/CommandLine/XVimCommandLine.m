...
- (id)init
{
        ...
        if (self) {
                ...
                [self.bottomAnchor constraintGreaterThanOrEqualToAnchor:_static.bottomAnchor constant:insets.bottom].active = YES;
                ...
                [self.bottomAnchor constraintGreaterThanOrEqualToAnchor:_error.bottomAnchor constant:insets.bottom].active = YES;
                ...
                [self.bottomAnchor constraintGreaterThanOrEqualToAnchor:_command.bottomAnchor constant:insets.bottom].active = YES;
                ...
                [self.bottomAnchor constraintGreaterThanOrEqualToAnchor:_argument.bottomAnchor constant:insets.bottom].active = YES;
