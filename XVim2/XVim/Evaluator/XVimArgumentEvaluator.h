 ...
 * In these case XVimNormalEvaluator create an object of this or subclass of this class and return it as a next
 *evaluator. After argument is provided onChildComplete method will use the object to know what the argument is.
 ...
 *   4. Use the property to do some operation for the result of the argument onChildComplete method in the parent
 *evaluator.
 *
