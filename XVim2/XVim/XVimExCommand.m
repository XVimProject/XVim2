...
- (id)init
{
    if (self = [super init]) {
        ...
        _excommands = [[NSArray alloc]
                    initWithObjects:CMD(@"append", @"append:inWindow:"), CMD(@"abbreviate", @"abbreviate:inWindow:"),
                                    CMD(@"abclear", @"abclear:inWindow:"),
                                    CMD(@"aboveleft", @"wrongmodifier:inWindow:"), CMD(@"all", @"all:inWindow:"),
                                    CMD(@"amenu", @"menu:inWindow:"), CMD(@"anoremenu", @"menu:inWindow:"),
                                    CMD(@"args", @"args:inWindow:"), CMD(@"argadd", @"argadd:inWindow:"),
                                    CMD(@"argdelete", @"argdelete:inWindow:"), CMD(@"argdo", @"listdo:inWindow:"),
                                    CMD(@"argedit", @"argedit:inWindow:"), CMD(@"argglobal", @"args:inWindow:"),
                                    CMD(@"arglocal", @"args:inWindow:"), CMD(@"argument", @"argument:inWindow:"),
                                    CMD(@"ascii", @"ascii:inWindow:"), CMD(@"autocmd", @"autocmd:inWindow:"),
                                    CMD(@"augroup", @"autocmd:inWindow:"), CMD(@"aunmenu", @"menu:inWindow:"),
                                    CMD(@"buffer", @"buffer:inWindow:"), CMD(@"bNext", @"bprevious:inWindow:"),
                                    CMD(@"ball", @"buffer_all:inWindow:"), CMD(@"badd", @"edit:inWindow:"),
                                    CMD(@"bdelete", @"bunload:inWindow:"), CMD(@"behave", @"behave:inWindow:"),
                                    CMD(@"belowright", @"wrongmodifier:inWindow:"),
                                    CMD(@"bfirst", @"brewind:inWindow:"), CMD(@"blast", @"blast:inWindow:"),
                                    CMD(@"bmodified", @"bmodified:inWindow:"), CMD(@"bnext", @"bnext:inWindow:"),
                                    CMD(@"botright", @"wrongmodifier:inWindow:"),
                                    CMD(@"bprevious", @"bprevious:inWindow:"), CMD(@"brewind", @"brewind:inWindow:"),
                                    CMD(@"break", @"break:inWindow:"), CMD(@"breakadd", @"breakadd:inWindow:"),
                                    CMD(@"breakdel", @"breakdel:inWindow:"), CMD(@"breaklist", @"breaklist:inWindow:"),
                                    CMD(@"browse", @"wrongmodifier:inWindow:"),
                                    CMD(@"buffers", @"buflist_list:inWindow:"), CMD(@"bufdo", @"listdo:inWindow:"),
                                    CMD(@"bunload", @"bunload:inWindow:"), CMD(@"bwipeout", @"bunload:inWindow:"),
                                    CMD(@"change", @"change:inWindow:"), CMD(@"cNext", @"cnext:inWindow:"),
                                    CMD(@"cNfile", @"cnext:inWindow:"), CMD(@"cabbrev", @"abbreviate:inWindow:"),
                                    CMD(@"cabclear", @"abclear:inWindow:"), CMD(@"caddbuffer", @"cbuffer:inWindow:"),
                                    CMD(@"caddexpr", @"cexpr:inWindow:"), CMD(@"caddfile", @"cfile:inWindow:"),
                                    CMD(@"call", @"call:inWindow:"), CMD(@"catch", @"catch:inWindow:"),
                                    CMD(@"cbuffer", @"cbuffer:inWindow:"), CMD(@"cc", @"cc:inWindow:"),
                                    CMD(@"cclose", @"cclose:inWindow:"), CMD(@"cd", @"cd:inWindow:"),
                                    CMD(@"center", @"align:inWindow:"), CMD(@"cexpr", @"cexpr:inWindow:"),
                                    CMD(@"cfile", @"cfile:inWindow:"), CMD(@"cfirst", @"cc:inWindow:"),
                                    CMD(@"cgetfile", @"cfile:inWindow:"), CMD(@"cgetbuffer", @"cbuffer:inWindow:"),
                                    CMD(@"cgetexpr", @"cexpr:inWindow:"), CMD(@"chdir", @"cd:inWindow:"),
                                    CMD(@"changes", @"changes:inWindow:"), CMD(@"checkpath", @"checkpath:inWindow:"),
                                    CMD(@"checktime", @"checktime:inWindow:"), CMD(@"clist", @"qf_list:inWindow:"),
                                    CMD(@"clast", @"cc:inWindow:"), CMD(@"close", @"close:inWindow:"),
                                    CMD(@"cmap", @"cmap:inWindow:"), CMD(@"cmapclear", @"cmapclear:inWindow:"),
                                    CMD(@"cmenu", @"menu:inWindow:"), CMD(@"cnext", @"cnext:inWindow:"),
                                    CMD(@"cnewer", @"qf_age:inWindow:"), CMD(@"cnfile", @"cnext:inWindow:"),
                                    CMD(@"cnoremap", @"cnoremap:inWindow:"),
                                    CMD(@"cnoreabbrev", @"abbreviate:inWindow:"), CMD(@"cnoremenu", @"menu:inWindow:"),
                                    CMD(@"copy", @"copy:inWindow:"), CMD(@"colder", @"qf_age:inWindow:"),
                                    ...
                                    CMD(@"comclear", @"comclear:inWindow:"), CMD(@"compiler", @"compiler:inWindow:"),
                                    CMD(@"continue", @"continue:inWindow:"),
                                    CMD(@"confirm", @"wrongmodifier:inWindow:"), CMD(@"copen", @"copen:inWindow:"),
                                    CMD(@"cprevious", @"cnext:inWindow:"), CMD(@"cpfile", @"cnext:inWindow:"),
                                    CMD(@"cquit", @"cquit:inWindow:"), CMD(@"crewind", @"cc:inWindow:"),
                                    CMD(@"cscope", @"cscope:inWindow:"), CMD(@"cstag", @"cstag:inWindow:"),
                                    CMD(@"cunmap", @"cunmap:inWindow:"), CMD(@"cunabbrev", @"abbreviate:inWindow:"),
                                    CMD(@"cunmenu", @"menu:inWindow:"), CMD(@"cwindow", @"cwindow:inWindow:"),
                                    CMD(@"delete", @"delete:inWindow:"), CMD(@"delmarks", @"delmarks:inWindow:"),
                                    ...
                                    CMD(@"display", @"display:inWindow:"), CMD(@"diffupdate", @"diffupdate:inWindow:"),
                                    CMD(@"diffget", @"diffgetput:inWindow:"), CMD(@"diffoff", @"diffoff:inWindow:"),
                                    CMD(@"diffpatch", @"diffpatch:inWindow:"), CMD(@"diffput", @"diffgetput:inWindow:"),
                                    CMD(@"diffsplit", @"diffsplit:inWindow:"), CMD(@"diffthis", @"diffthis:inWindow:"),
                                    CMD(@"digraphs", @"digraphs:inWindow:"), CMD(@"djump", @"findpat:inWindow:"),
                                    CMD(@"dlist", @"findpat:inWindow:"), CMD(@"doautocmd", @"doautocmd:inWindow:"),
                                    CMD(@"doautoall", @"doautoall:inWindow:"), CMD(@"drop", @"drop:inWindow:"),
                                    CMD(@"dsearch", @"findpat:inWindow:"), CMD(@"dsplit", @"findpat:inWindow:"),
                                    CMD(@"edit", @"edit:inWindow:"), CMD(@"earlier", @"later:inWindow:"),
                                    CMD(@"echo", @"echo:inWindow:"), CMD(@"echoerr", @"execute:inWindow:"),
                                    CMD(@"echohl", @"echohl:inWindow:"), CMD(@"echomsg", @"execute:inWindow:"),
                                    CMD(@"echon", @"echo:inWindow:"), CMD(@"else", @"else:inWindow:"),
                                    CMD(@"elseif", @"else:inWindow:"), CMD(@"emenu", @"emenu:inWindow:"),
                                    CMD(@"endif", @"endif:inWindow:"), CMD(@"endfunction", @"endfunction:inWindow:"),
                                    CMD(@"endfor", @"endwhile:inWindow:"), CMD(@"endtry", @"endtry:inWindow:"),
                                    CMD(@"endwhile", @"endwhile:inWindow:"), CMD(@"enew", @"edit:inWindow:"),
                                    CMD(@"ex", @"edit:inWindow:"), CMD(@"execute", @"execute:inWindow:"),
                                    CMD(@"exit", @"exit:inWindow:"), CMD(@"exusage", @"exusage:inWindow:"),
                                    CMD(@"file", @"file:inWindow:"), CMD(@"files", @"buflist_list:inWindow:"),
                                    CMD(@"filetype", @"filetype:inWindow:"), CMD(@"find", @"find:inWindow:"),
                                    CMD(@"finally", @"finally:inWindow:"), CMD(@"finish", @"finish:inWindow:"),
                                    CMD(@"first", @"rewind:inWindow:"), CMD(@"fixdel", @"fixdel:inWindow:"),
                                    CMD(@"fold", @"fold:inWindow:"), CMD(@"foldclose", @"foldopen:inWindow:"),
                                    CMD(@"folddoopen", @"folddo:inWindow:"), CMD(@"folddoclosed", @"folddo:inWindow:"),
                                    CMD(@"foldopen", @"foldopen:inWindow:"), CMD(@"for", @"while:inWindow:"),
                                    CMD(@"function", @"function:inWindow:"), CMD(@"global", @"global:inWindow:"),
                                    CMD(@"goto", @"goto:inWindow:"), CMD(@"grep", @"make:inWindow:"),
                                    CMD(@"grepadd", @"make:inWindow:"), CMD(@"gui", @"gui:inWindow:"),
                                    CMD(@"gvim", @"gui:inWindow:"), CMD(@"help", @"help:inWindow:"),
                                    CMD(@"helpfind", @"helpfind:inWindow:"), CMD(@"helpgrep", @"helpgrep:inWindow:"),
                                    CMD(@"helptags", @"helptags:inWindow:"), CMD(@"hardcopy", @"hardcopy:inWindow:"),
                                    CMD(@"highlight", @"highlight:inWindow:"), CMD(@"hide", @"hide:inWindow:"),
                                    CMD(@"history", @"history:inWindow:"), CMD(@"insert", @"append:inWindow:"),
                                    CMD(@"iabbrev", @"abbreviate:inWindow:"), CMD(@"iabclear", @"abclear:inWindow:"),
                                    CMD(@"if", @"if:inWindow:"), CMD(@"ijump", @"findpat:inWindow:"),
                                    CMD(@"ilist", @"findpat:inWindow:"), CMD(@"imap", @"imap:inWindow:"),
                                    CMD(@"imapclear", @"imapclear:inWindow:"), CMD(@"imenu", @"menu:inWindow:"),
                                    CMD(@"inoremap", @"inoremap:inWindow:"),
                                    CMD(@"inoreabbrev", @"abbreviate:inWindow:"), CMD(@"inoremenu", @"menu:inWindow:"),
                                    CMD(@"intro", @"intro:inWindow:"), CMD(@"isearch", @"findpat:inWindow:"),
                                    CMD(@"isplit", @"findpat:inWindow:"), CMD(@"iunmap", @"iunmap:inWindow:"),
                                    CMD(@"iunabbrev", @"abbreviate:inWindow:"), CMD(@"iunmenu", @"menu:inWindow:"),
                                    CMD(@"join", @"join:inWindow:"), CMD(@"jumps", @"jumps:inWindow:"),
                                    CMD(@"k", @"mark:inWindow:"), CMD(@"keepmarks", @"wrongmodifier:inWindow:"),
                                    CMD(@"keepjumps", @"wrongmodifier:inWindow:"),
                                    CMD(@"keepalt", @"wrongmodifier:inWindow:"), CMD(@"list", @"print:inWindow:"),
                                    CMD(@"lNext", @"cnext:inWindow:"), CMD(@"lNfile", @"cnext:inWindow:"),
                                    CMD(@"last", @"last:inWindow:"), CMD(@"language", @"language:inWindow:"),
                                    CMD(@"laddexpr", @"cexpr:inWindow:"), CMD(@"laddbuffer", @"cbuffer:inWindow:"),
                                    CMD(@"laddfile", @"cfile:inWindow:"), CMD(@"later", @"later:inWindow:"),
                                    CMD(@"lbuffer", @"cbuffer:inWindow:"), CMD(@"lcd", @"cd:inWindow:"),
                                    CMD(@"lchdir", @"cd:inWindow:"), CMD(@"lclose", @"cclose:inWindow:"),
                                    CMD(@"lcscope", @"cscope:inWindow:"), CMD(@"left", @"align:inWindow:"),
                                    CMD(@"leftabove", @"wrongmodifier:inWindow:"), CMD(@"let", @"let:inWindow:"),
                                    CMD(@"lexpr", @"cexpr:inWindow:"), CMD(@"lfile", @"cfile:inWindow:"),
                                    CMD(@"lfirst", @"cc:inWindow:"), CMD(@"lgetfile", @"cfile:inWindow:"),
                                    CMD(@"lgetbuffer", @"cbuffer:inWindow:"), CMD(@"lgetexpr", @"cexpr:inWindow:"),
                                    CMD(@"lgrep", @"make:inWindow:"), CMD(@"lgrepadd", @"make:inWindow:"),
                                    CMD(@"lhelpgrep", @"helpgrep:inWindow:"), CMD(@"ll", @"cc:inWindow:"),
                                    CMD(@"llast", @"cc:inWindow:"), CMD(@"llist", @"qf_list:inWindow:"),
                                    CMD(@"lmap", @"map:inWindow:"), CMD(@"lmapclear", @"mapclear:inWindow:"),
                                    CMD(@"lmake", @"make:inWindow:"), CMD(@"lnoremap", @"map:inWindow:"),
                                    CMD(@"lnext", @"cnext:inWindow:"), CMD(@"lnewer", @"qf_age:inWindow:"),
                                    CMD(@"lnfile", @"cnext:inWindow:"), CMD(@"loadview", @"loadview:inWindow:"),
                                    CMD(@"loadkeymap", @"loadkeymap:inWindow:"),
                                    CMD(@"lockmarks", @"wrongmodifier:inWindow:"),
                                    CMD(@"lockvar", @"lockvar:inWindow:"), CMD(@"lolder", @"qf_age:inWindow:"),
                                    CMD(@"lopen", @"copen:inWindow:"), CMD(@"lprevious", @"cnext:inWindow:"),
                                    CMD(@"lpfile", @"cnext:inWindow:"), CMD(@"lrewind", @"cc:inWindow:"),
                                    CMD(@"ltag", @"tag:inWindow:"), CMD(@"lunmap", @"unmap:inWindow:"),
                                    ...
                                    CMD(@"messages", @"messages:inWindow:"), CMD(@"mkexrc", @"mkrc:inWindow:"),
                                    CMD(@"mksession", @"mkrc:inWindow:"), CMD(@"mkspell", @"mkspell:inWindow:"),
                                    CMD(@"mkvimrc", @"mkrc:inWindow:"), CMD(@"mkview", @"mkrc:inWindow:"),
                                    CMD(@"mode", @"mode:inWindow:"), CMD(@"mzscheme", @"mzscheme:inWindow:"),
                                    CMD(@"mzfile", @"mzfile:inWindow:"), CMD(@"next", @"next:inWindow:"),
                                    ...
                                    CMD(@"nmap", @"nmap:inWindow:"), CMD(@"nmapclear", @"nmapclear:inWindow:"),
                                    CMD(@"nmenu", @"menu:inWindow:"), CMD(@"nnoremap", @"nnoremap:inWindow:"),
                                    CMD(@"nnoremenu", @"menu:inWindow:"), CMD(@"noremap", @"noremap:inWindow:"),
                                    CMD(@"noautocmd", @"wrongmodifier:inWindow:"),
                                    CMD(@"nohlsearch", @"nohlsearch:inWindow:"),
                                    CMD(@"noreabbrev", @"abbreviate:inWindow:"), CMD(@"noremenu", @"menu:inWindow:"),
                                    CMD(@"normal", @"normal:inWindow:"), CMD(@"number", @"print:inWindow:"),
                                    CMD(@"nunmap", @"unmap:inWindow:"), CMD(@"nunmenu", @"menu:inWindow:"),
                                    CMD(@"open", @"open:inWindow:"), CMD(@"oldfiles", @"oldfiles:inWindow:"),
                                    CMD(@"omap", @"omap:inWindow:"), CMD(@"omapclear", @"mapclear:inWindow:"),
                                    CMD(@"omenu", @"menu:inWindow:"), CMD(@"only", @"only:inWindow:"),
                                    CMD(@"onoremap", @"onoremap:inWindow:"), CMD(@"onoremenu", @"menu:inWindow:"),
                                    CMD(@"options", @"options:inWindow:"), CMD(@"ounmap", @"ounmap:inWindow:"),
                                    CMD(@"ounmenu", @"menu:inWindow:"), CMD(@"print", @"print:inWindow:"),
                                    CMD(@"pcounterpart", @"pcounterpart:inWindow:"), // XVim Original (This overrides
                                                                                     // original Vim's :pc command)
                                    CMD(@"pclose", @"pclose:inWindow:"), CMD(@"perl", @"perl:inWindow:"),
                                    CMD(@"perldo", @"perldo:inWindow:"), CMD(@"pedit", @"pedit:inWindow:"),
                                    CMD(@"pissue", @"pissue:inWindow:"), // XVim Original
                                    CMD(@"pjump", @"pjump:inWindow:"), // XVim Original
                                    CMD(@"pop", @"tag:inWindow:"), CMD(@"popup", @"popup:inWindow:"),
                                    CMD(@"ppop", @"ptag:inWindow:"), CMD(@"preserve", @"preserve:inWindow:"),
                                    CMD(@"previous", @"previous:inWindow:"),
                                    CMD(@"promptfind", @"gui_mch_find_dialog:inWindow:"),
                                    CMD(@"promptrepl", @"gui_mch_replace_dialog:inWindow:"),
                                    CMD(@"profile", @"profile:inWindow:"), CMD(@"profdel", @"breakdel:inWindow:"),
                                    CMD(@"psearch", @"psearch:inWindow:"), CMD(@"ptag", @"ptag:inWindow:"),
                                    CMD(@"ptNext", @"ptag:inWindow:"), CMD(@"ptfirst", @"ptag:inWindow:"),
                                    CMD(@"ptjump", @"ptag:inWindow:"), CMD(@"ptlast", @"ptag:inWindow:"),
                                    CMD(@"ptnext", @"ptag:inWindow:"), CMD(@"ptprevious", @"ptag:inWindow:"),
                                    CMD(@"ptrewind", @"ptag:inWindow:"), CMD(@"ptselect", @"ptag:inWindow:"),
                                    CMD(@"put", @"put:inWindow:"), CMD(@"pwd", @"pwd:inWindow:"),
                                    CMD(@"python", @"python:inWindow:"), CMD(@"pyfile", @"pyfile:inWindow:"),
                                    CMD(@"quit", @"quit:inWindow:"), CMD(@"quitall", @"quit_all:inWindow:"),
                                    CMD(@"qall", @"quit_all:inWindow:"), CMD(@"read", @"read:inWindow:"),
                                    CMD(@"recover", @"recover:inWindow:"), CMD(@"redo", @"redo:inWindow:"),
                                    CMD(@"redir", @"redir:inWindow:"), CMD(@"redraw", @"redraw:inWindow:"),
                                    CMD(@"redrawstatus", @"redrawstatus:inWindow:"),
                                    CMD(@"registers", @"reg:inWindow:"), CMD(@"resize", @"resize:inWindow:"),
                                    CMD(@"retab", @"retab:inWindow:"), CMD(@"return", @"return:inWindow:"),
                                    CMD(@"rewind", @"rewind:inWindow:"), CMD(@"right", @"align:inWindow:"),
                                    CMD(@"rightbelow", @"wrongmodifier:inWindow:"),
                                    CMD(@"run", @"run:inWindow:"), // This is XVim original command
                                    CMD(@"runtime", @"runtime:inWindow:"), CMD(@"ruby", @"ruby:inWindow:"),
                                    CMD(@"rubydo", @"rubydo:inWindow:"), CMD(@"rubyfile", @"rubyfile:inWindow:"),
                                    CMD(@"rviminfo", @"viminfo:inWindow:"), CMD(@"substitute", @"sub:inWindow:"),
                                    CMD(@"sNext", @"previous:inWindow:"), CMD(@"sargument", @"argument:inWindow:"),
                                    CMD(@"sall", @"all:inWindow:"), CMD(@"sandbox", @"wrongmodifier:inWindow:"),
                                    CMD(@"saveas", @"write:inWindow:"), CMD(@"sbuffer", @"buffer:inWindow:"),
                                    CMD(@"sbNext", @"bprevious:inWindow:"), CMD(@"sball", @"buffer_all:inWindow:"),
                                    CMD(@"sbfirst", @"brewind:inWindow:"), CMD(@"sblast", @"blast:inWindow:"),
                                    CMD(@"sbmodified", @"bmodified:inWindow:"), CMD(@"sbnext", @"bnext:inWindow:"),
                                    CMD(@"sbprevious", @"bprevious:inWindow:"), CMD(@"sbrewind", @"brewind:inWindow:"),
                                    CMD(@"scriptnames", @"scriptnames:inWindow:"),
                                    CMD(@"scriptencoding", @"scriptencoding:inWindow:"),
                                    CMD(@"scscope", @"scscope:inWindow:"), CMD(@"set", @"set:inWindow:"),
                                    CMD(@"setfiletype", @"setfiletype:inWindow:"), CMD(@"setglobal", @"set:inWindow:"),
                                    CMD(@"setlocal", @"set:inWindow:"), CMD(@"sfind", @"splitview:inWindow:"),
                                    CMD(@"sfirst", @"rewind:inWindow:"), CMD(@"shell", @"shell:inWindow:"),
                                    CMD(@"simalt", @"simalt:inWindow:"), CMD(@"sign", @"sign:inWindow:"),
                                    CMD(@"silent", @"wrongmodifier:inWindow:"), CMD(@"sleep", @"sleep:inWindow:"),
                                    CMD(@"slast", @"last:inWindow:"), CMD(@"smagic", @"submagic:inWindow:"),
                                    CMD(@"smap", @"smap:inWindow:"), CMD(@"smapclear", @"smapclear:inWindow:"),
                                    CMD(@"smenu", @"menu:inWindow:"), CMD(@"snext", @"next:inWindow:"),
                                    CMD(@"sniff", @"sniff:inWindow:"), CMD(@"snomagic", @"submagic:inWindow:"),
                                    CMD(@"snoremap", @"snoremap:inWindow:"), CMD(@"snoremenu", @"menu:inWindow:"),
                                    CMD(@"source", @"source:inWindow:"), CMD(@"sort", @"sort:inWindow:"),
                                    CMD(@"sort!", @"sort:inWindow:"), CMD(@"split", @"splitview:inWindow:"),
                                    CMD(@"spellgood", @"spell:inWindow:"), CMD(@"spelldump", @"spelldump:inWindow:"),
                                    CMD(@"spellinfo", @"spellinfo:inWindow:"),
                                    CMD(@"spellrepall", @"spellrepall:inWindow:"),
                                    CMD(@"spellundo", @"spell:inWindow:"), CMD(@"spellwrong", @"spell:inWindow:"),
                                    CMD(@"sprevious", @"previous:inWindow:"), CMD(@"srewind", @"rewind:inWindow:"),
                                    CMD(@"stop", @"stop:inWindow:"), CMD(@"stag", @"stag:inWindow:"),
                                    CMD(@"startinsert", @"startinsert:inWindow:"),
                                    CMD(@"startgreplace", @"startinsert:inWindow:"),
                                    CMD(@"startreplace", @"startinsert:inWindow:"),
                                    CMD(@"stopinsert", @"stopinsert:inWindow:"), CMD(@"stjump", @"stag:inWindow:"),
                                    CMD(@"stselect", @"stag:inWindow:"), CMD(@"sunhide", @"buffer_all:inWindow:"),
                                    CMD(@"sunmap", @"sunmap:inWindow:"), CMD(@"sunmenu", @"menu:inWindow:"),
                                    CMD(@"suspend", @"stop:inWindow:"), CMD(@"sview", @"splitview:inWindow:"),
                                    CMD(@"swapname", @"swapname:inWindow:"), CMD(@"syntax", @"syntax:inWindow:"),
                                    CMD(@"syncbind", @"syncbind:inWindow:"), CMD(@"t", @"copy:inWindow:"),
                                    CMD(@"tNext", @"tag:inWindow:"), CMD(@"tag", @"tag:inWindow:"),
                                    CMD(@"tags", @"tags:inWindow:"), CMD(@"tab", @"wrongmodifier:inWindow:"),
                                    CMD(@"tabclose", @"tabclose:inWindow:"), CMD(@"tabdo", @"listdo:inWindow:"),
                                    CMD(@"tabedit", @"splitview:inWindow:"), CMD(@"tabfind", @"splitview:inWindow:"),
                                    CMD(@"tabfirst", @"tabnext:inWindow:"), CMD(@"tabmove", @"tabmove:inWindow:"),
                                    CMD(@"tablast", @"tabnext:inWindow:"), CMD(@"tabnext", @"tabnext:inWindow:"),
                                    CMD(@"tabnew", @"splitview:inWindow:"), CMD(@"tabonly", @"tabonly:inWindow:"),
                                    CMD(@"tabprevious", @"tabprevious:inWindow:"),
                                    CMD(@"tabNext", @"tabnext:inWindow:"), CMD(@"tabrewind", @"tabnext:inWindow:"),
                                    CMD(@"tabs", @"tabs:inWindow:"), CMD(@"tcl", @"tcl:inWindow:"),
                                    CMD(@"tcldo", @"tcldo:inWindow:"), CMD(@"tclfile", @"tclfile:inWindow:"),
                                    CMD(@"tearoff", @"tearoff:inWindow:"),
                                    CMD(@"test", @"test:inWindow:"), // XVim test case runner
                                    CMD(@"tfirst", @"tag:inWindow:"), CMD(@"throw", @"throw:inWindow:"),
                                    CMD(@"tjump", @"tag:inWindow:"), CMD(@"tlast", @"tag:inWindow:"),
                                    CMD(@"tmenu", @"menu:inWindow:"), CMD(@"tnext", @"tag:inWindow:"),
                                    CMD(@"topleft", @"wrongmodifier:inWindow:"), CMD(@"tprevious", @"tag:inWindow:"),
                                    CMD(@"trewind", @"tag:inWindow:"), CMD(@"try", @"try:inWindow:"),
                                    CMD(@"tselect", @"tag:inWindow:"), CMD(@"tunmenu", @"menu:inWindow:"),
                                    CMD(@"undo", @"undo:inWindow:"), CMD(@"undojoin", @"undojoin:inWindow:"),
                                    CMD(@"undolist", @"undolist:inWindow:"),
                                    CMD(@"unabbreviate", @"abbreviate:inWindow:"),
                                    CMD(@"unhide", @"buffer_all:inWindow:"), CMD(@"unlet", @"unlet:inWindow:"),
                                    CMD(@"unlockvar", @"lockvar:inWindow:"), CMD(@"unmap", @"unmap:inWindow:"),
                                    CMD(@"unmenu", @"menu:inWindow:"), CMD(@"unsilent", @"wrongmodifier:inWindow:"),
                                    CMD(@"update", @"update:inWindow:"), CMD(@"vglobal", @"global:inWindow:"),
                                    CMD(@"version", @"version:inWindow:"), CMD(@"verbose", @"wrongmodifier:inWindow:"),
                                    CMD(@"vertical", @"wrongmodifier:inWindow:"), CMD(@"visual", @"edit:inWindow:"),
                                    CMD(@"view", @"edit:inWindow:"), CMD(@"vimgrep", @"vimgrep:inWindow:"),
                                    CMD(@"vimgrepadd", @"vimgrep:inWindow:"), CMD(@"viusage", @"viusage:inWindow:"),
                                    CMD(@"vmap", @"vmap:inWindow:"), CMD(@"vmapclear", @"vmapclear:inWindow:"),
                                    CMD(@"vmenu", @"menu:inWindow:"), CMD(@"vnoremap", @"vnoremap:inWindow:"),
                                    CMD(@"vnew", @"splitview:inWindow:"), CMD(@"vnoremenu", @"menu:inWindow:"),
                                    CMD(@"vsplit", @"vsplitview:inWindow:"), CMD(@"vunmap", @"vunmap:inWindow:"),
                                    CMD(@"vunmenu", @"menu:inWindow:"), CMD(@"write", @"write:inWindow:"),
                                    CMD(@"wNext", @"wnext:inWindow:"), CMD(@"wall", @"wqall:inWindow:"),
                                    CMD(@"while", @"while:inWindow:"), CMD(@"winsize", @"winsize:inWindow:"),
                                    CMD(@"wincmd", @"wincmd:inWindow:"), CMD(@"windo", @"listdo:inWindow:"),
                                    CMD(@"winpos", @"winpos:inWindow:"), CMD(@"wnext", @"wnext:inWindow:"),
                                    CMD(@"wprevious", @"wnext:inWindow:"), CMD(@"wq", @"exit:inWindow:"),
                                    CMD(@"wqall", @"wqall:inWindow:"), CMD(@"wsverb", @"wsverb:inWindow:"),
                                    CMD(@"wviminfo", @"viminfo:inWindow:"), CMD(@"xccmd", @"xccmd:inWindow:"),
                                    ...
                                    CMD(@"xit", @"exit:inWindow:"), CMD(@"xall", @"wqall:inWindow:"),
                                    CMD(@"xmap", @"xmap:inWindow:"), CMD(@"xmapclear", @"xmapclear:inWindow:"),
                                    CMD(@"xmenu", @"menu:inWindow:"), CMD(@"xnoremap", @"xnoremap:inWindow:"),
                                    CMD(@"xnoremenu", @"menu:inWindow:"), CMD(@"xunmap", @"xunmap:inWindow:"),
                                    CMD(@"xunmenu", @"menu:inWindow:"), CMD(@"yank", @"yank:inWindow:"),
                                    CMD(@"z", @"z:inWindow:"), CMD(@"!", @"bang:inWindow:"),
                                    CMD(@"#", @"print:inWindow:"), CMD(@"&", @"sub:inWindow:"),
                                    CMD(@"*", @"at:inWindow:"), CMD(@"<", @"shift:inWindow:"),
                                    CMD(@"=", @"equal:inWindow:"), CMD(@">", @"shift:inWindow:"),
                                    CMD(@"@", @"at:inWindow:"), CMD(@"Next", @"previous:inWindow:"),
                                    CMD(@"Print", @"print:inWindow:"), CMD(@"X", @"X:inWindow:"),
                                    CMD(@"~", @"sub:inWindow:"), nil];
    }
    return self;
}
...
- (void)cmap:(XVimExArg*)args inWindow:(XVimWindow*)window { [self mapMode:XVIM_MODE_CMDLINE withArgs:args remap:YES]; }
...
- (void)cunmap:(XVimExArg*)args inWindow:(XVimWindow*)window { [self unmapMode:XVIM_MODE_CMDLINE withArgs:args]; }

- (void)cmapclear:(XVimExArg*)args inWindow:(XVimWindow*)window { [self mapClearMode:XVIM_MODE_CMDLINE]; }
...
- (void)highlight:(XVimExArg*)args inWindow:(XVimWindow*)window
{
    ...
    while (!scanner.isAtEnd) {
        ...
        NSString* equal = nil;
        [scanner scanCharactersFromSet:[NSMutableCharacterSet characterSetWithCharactersInString:@"="]
                               intoString:&equal];
        if (scanner.isAtEnd) {
            return;
        }
...
- (void)imap:(XVimExArg*)args inWindow:(XVimWindow*)window { [self mapMode:XVIM_MODE_INSERT withArgs:args remap:YES]; }
...
- (void)iunmap:(XVimExArg*)args inWindow:(XVimWindow*)window { [self unmapMode:XVIM_MODE_INSERT withArgs:args]; }

- (void)imapclear:(XVimExArg*)args inWindow:(XVimWindow*)window { [self mapClearMode:XVIM_MODE_INSERT]; }

- (void)make:(XVimExArg*)args inWindow:(XVimWindow*)window
{
    NSWindow* activeWindow = [[NSApplication sharedApplication] mainWindow];
    NSEvent* keyPress = [NSEvent keyEventWithType:NSEventTypeKeyDown
                                         location:[NSEvent mouseLocation]
                                    modifierFlags:NSEventModifierFlagCommand
                                        timestamp:[[NSDate date] timeIntervalSince1970]
                                     windowNumber:[activeWindow windowNumber]
                                          context:[NSGraphicsContext graphicsContextWithWindow:activeWindow]
                                       characters:@"b"
...
- (void)yank:(XVimExArg*)args inWindow:(XVimWindow*)window
{
    ...
    if (args.lineBegin == NSNotFound && args.lineEnd == NSNotFound)
        return;
    let view = [window sourceView];
    [view xvim_yank:[XVimMotion style:MOTION_LINE_FORWARD type:LINEWISE count:
...
- (void) delete:(XVimExArg*)args inWindow:(XVimWindow*)window
{
    if (args.lineBegin == NSNotFound && args.lineEnd == NSNotFound)
        return;
    let view = [window sourceView];
    [view xvim_delete:[XVimMotion style:MOTION_LINE_FORWARD type:LINEWISE count:
                                       args.lineEnd != NSNotFound ? args.lineEnd - args.lineBegin : 1]
                withMotionPoint:[view xvim_indexOfLineNumber:args.lineBegin]
                        andYank:YES];
}

- (void)copy:(XVimExArg*)args inWindow:(XVimWindow*)window { [self copymove:args onlyCopy:YES inWindow:window]; }

- (void)move:(XVimExArg*)args inWindow:(XVimWindow*)window { [self copymove:args onlyCopy:NO inWindow:window]; }
...
- (void)copymove:(XVimExArg*)args onlyCopy:(bool)onlyCopy inWindow:(XVimWindow*)window
{
    ...
    [view xvim_copymove:[XVimMotion style:MOTION_LINE_FORWARD type:LINEWISE count:
                                         args.lineEnd != NSNotFound ? args.lineEnd - args.lineBegin : 1]
                   withMotionPoint:[view xvim_indexOfLineNumber:args.lineBegin]
...
- (void)shift:(XVimExArg*)args inWindow:(XVimWindow*)window
{
    ...
    if (args.arg != nil
        && ![[@"" stringByPaddingToLength:args.arg.length withString:[args.cmd substringFromIndex:0] startingAtIndex:0]
                       isEqualToString:args.arg]) {
        return;
    }
    let view = [window sourceView];
    XVimMotion* motion = [XVimMotion style:MOTION_LINE_FORWARD type:LINEWISE count:
                                          args.lineEnd != NSNotFound ? args.lineEnd - args.lineBegin : 1];
...
- (void)nunmap:(XVimExArg*)args inWindow:(XVimWindow*)window { [self unmapMode:XVIM_MODE_NORMAL withArgs:args]; }

- (void)nmapclear:(XVimExArg*)args inWindow:(XVimWindow*)window { [self mapClearMode:XVIM_MODE_NORMAL]; }
...
- (void)omapclear:(XVimExArg*)args inWindow:(XVimWindow*)window { [self mapClearMode:XVIM_MODE_OPERATOR_PENDING]; }
...
- (void)set:(XVimExArg*)args inWindow:(XVimWindow*)window
{
    ...
    if ([setCommand isEqualToString:@"wrap"]) {
        // TODO: [srcView xvim_setWrapsLines:YES];
    }
    else if ([setCommand isEqualToString:@"nowrap"]) {
        // TODO: [srcView xvim_setWrapsLines:NO];
    }
...
- (void)sort:(XVimExArg*)args inWindow:(XVimWindow*)window
{
    ...
    if (argsString) {
#define STR_CONTAINS_ARG(str, arg)                                                                                     \
    ([str rangeOfCharacterFromSet:[NSCharacterSet characterSetWithCharactersInString:arg]].location != NSNotFound)
...
- (void)vunmap:(XVimExArg*)args inWindow:(XVimWindow*)window { [self unmapMode:XVIM_MODE_VISUAL withArgs:args]; }

- (void)vmapclear:(XVimExArg*)args inWindow:(XVimWindow*)window { [self mapClearMode:XVIM_MODE_VISUAL]; }
...
{
    // TODO: [NSApp sendAction:@selector(showQuickHelp:) to:nil from:self];
}
                                          ...
                                          if (nextMatchedRange.location != NSNotFound) {
                                              ...
                                              for (NSUInteger modIdx = 1; modIdx < [matchedToken2 length];
                                                  ...
                                                  case 'h': // return 'head' of path (chop off last component)
                                                      substituteValue =
                                                                  [substituteValue stringByDeletingLastPathComponent];
                                                      break;
...
- (void)echo:(XVimExArg*)args inWindow:(XVimWindow*)window { [window statusMessage:args.arg]; }
