...
typedef NS_ENUM(NSInteger, XVIM_CURSOR_MODE) {
    XVIM_CURSOR_MODE_INSERT,
    XVIM_CURSOR_MODE_COMMAND
};
...
typedef NS_ENUM(NSUInteger, XVIM_VISUAL_CORNER) {
    ...
    XVIM_VISUAL_RIGHT = XVIM_VISUAL_TOPRIGHT,
    XVIM_VISUAL_BOTTOM = XVIM_VISUAL_BOTTOMLEFT,
};
