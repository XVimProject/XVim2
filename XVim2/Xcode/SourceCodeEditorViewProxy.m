...
+ (void)initialize
{
        if (self == [SourceCodeEditorViewProxy class]) {
                ...
                fpEndEditingTransaction = function_ptr_from_name("_T012SourceEditor0aB4ViewC04dataA18EndEditTransactionyyF", NULL);
...
- (void)setCursorStyle:(CursorStyle)cursorStyle
{
        ...
        __asm__(
                    ...
                    "popq %%r13\n\t"
                    : /* no output */
                    : "r"(cursorStyle), "r"(sev), "m"(fpSetCursorStyle)
                    : "memory", "cc");
}
