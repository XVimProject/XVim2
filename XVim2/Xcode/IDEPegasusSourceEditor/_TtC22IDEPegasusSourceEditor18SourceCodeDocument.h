...
- (id)_insertObjCSourceCode:(id)arg1
            ...
            firstPossibleItemToInsertBefore:(id)arg4
                                      error:(id*)arg5;
//- (id)_insertObjCSourceCode:(id)arg1 inContainingSourceModelItem:(id)arg2 withInsertAfterHint:(id)arg3
//andInsertBeforeHint:(id)arg4 ignoreHintItemsConformingToSpecifications:(id)arg5
//onlyConsiderItemsConformingToSpecifications:(id)arg6 insertAdditionalNewline:(BOOL)arg7
...
//- (id)_insertSourceCode:(id)arg1 atBeginningOfContainingSourceModelItem:(id)arg2 insertOnNextLine:(BOOL)arg3
...
//- (id)_insertSourceCode:(id)arg1 atEndOfContainingSourceModelItem:(id)arg2 insertOnNextLine:(BOOL)arg3
//beforeItemMatchingPredicateBlock:(CDUnknownBlockType)arg4;
- (id)_insertSwiftSourceCode:(id)arg1
             inContainingSourceLandmarkItem:(id)arg2
              asCloseAsPossibleToLineNumber:(unsigned long long)arg3
            firstPossibleItemToInsertBefore:(id)arg4
                                      error:(id*)arg5;
...
- (id)_primitiveAddObjectiveCReleaseForTeardownMethodWithSourceCodeGenerator:(id)arg1
...
- (id)_primitiveAddSwiftReleaseForTeardownMethodWithSourceCodeGenerator:(id)arg1
                                                          withReleaseCallCode:(id)arg2
                                                                  inClassItem:(id)arg3
                                                                      options:(id)arg4
                                                                        error:(id*)arg5;
- (id)_primitiveAddSwiftSourceCode:(id)arg1
                                                        toClassItem:(id)arg2
                                                        withOptions:(id)arg3
            insertAdditionalNewlineWhenInsertingWithAfterBeforeHint:(BOOL)arg4
                                insertAtEndWhenInsertingWithoutHint:(BOOL)arg5
...
//- (id)_primitiveInsertSourceCode:(id)arg1 atBeginning:(BOOL)arg2 ofContainingSourceModelItem:(id)arg3
//insertOnNextLine:(BOOL)arg4 afterOrBeforeItemMatchingPredicateBlock:(CDUnknownBlockType)arg5;
...
- (id)completionItemsForDocumentLocation:(id)arg1
                                       context:(id)arg2
                   highlyLikelyCompletionItems:(id*)arg3
                                 areDefinitive:(char*)arg4;
...
@property (nonatomic, copy)
            NSDictionary* firstEditorWorkspaceBuildSettings; // @synthesize firstEditorWorkspaceBuildSettings;
@property (nonatomic, retain)
            DVTObservingToken* firstEditorWorkspaceObservingToken; // @synthesize firstEditorWorkspaceObservingToken;
...
@property (nonatomic, retain) id<DVTCancellable>
            inFlightExtensionCommandTimer; // @synthesize inFlightExtensionCommandTimer;
@property (nonatomic, retain) id<DVTCancellable>
            inFlightExtensionCommandToken; // @synthesize inFlightExtensionCommandToken;
...
@property (nonatomic, retain)
            IDEMediaResourceVariantContext* variantContextForMediaLibrary; // @synthesize variantContextForMediaLibrary;
@property (nonatomic, copy)
            NSDictionary* variantForResolvingMediaResources; // @synthesize variantForResolvingMediaResources;
            ...
            prepareToAddObjectiveCPropertyReleaseForTeardownWithName:(id)arg2
                                                        ...
                                                        inClassNamed:(id)arg4
                                                             options:(id)arg5
                                                               error:(id*)arg6;
- (id)sourceCodeGenerator:(id)arg1
            prepareToAddSwiftClassMethodDefinitionWithName:(id)arg2
                                               inClassItem:(id)arg3
                                                   options:(id)arg4
                                                     error:(id*)arg5;
- (id)sourceCodeGenerator:(id)arg1
            prepareToAddSwiftInstanceMethodDefinitionWithName:(id)arg2
                                                  inClassItem:(id)arg3
                                                      options:(id)arg4
                                                        error:(id*)arg5;
- (id)sourceCodeGenerator:(id)arg1
            prepareToAddSwiftInstanceVariableReleaseForTeardownWithName:(id)arg2
                                                            inClassItem:(id)arg3
                                                                options:(id)arg4
                                                                  error:(id*)arg5;
- (id)sourceCodeGenerator:(id)arg1
            prepareToAddSwiftPropertyDeclarationWithName:(id)arg2
                                                    type:(id)arg3
                                             inClassItem:(id)arg4
                                                 options:(id)arg5
                                                   error:(id*)arg6;
