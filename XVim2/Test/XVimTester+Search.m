...
- (NSArray*)search_testcases
{
    ...
    return [NSArray arrayWithObjects:
                                ...
                                XVimMakeTestCase(text8, 0, 0, @":set vimregex<CR>:%s/\\bbbb\\b/ddd/g<CR>",
                                                 replace11_result, 19, 0),
                                ...
                                // Currently operations with search is supported but not exactly compatible to Vim's
                                // behavior. This is related to the fact that XVim moves cursor before doing */# search
                                // not to match the searched string itsself. XVimMakeTestCase(text2, 5,  0, @"2d*" ,
                                // operation_result1, 5, 0), XVimMakeTestCase(text2,45,  0, @"2d#" , operation_result2,
                                // 4, 0),
                                ...
                                XVimMakeTestCase(text5, 5, 0, @":set vimregex<CR>:set noignorecase<CR>/bbb\\c<CR>",
                                                 text5, 28, 0), // should ignore case
                                XVimMakeTestCase(text5, 5, 0, @":set vimregex<CR>:set ignorecase<CR>/bbb\\C<CR>", text5,
                                                 44, 0), // should not ignore case
                                ...
                                // search followed by implicit replace. added to cover
                                // https://github.com/XVimProject/XVim/issues/730
                                XVimMakeTestCase(text8, 0, 0, @":set vimregex<CR>/bbb<CR>:%s//ddd/g<CR>",
                                                 replace11_result, 19, 0),
                                nil];
}
@end
