...
NS_INLINE NSPoint AddPoint(NSPoint a, NSPoint b) { return NSMakePoint(a.x + b.x, a.y + b.y); }

NS_INLINE NSPoint SubPoint(NSPoint a, NSPoint b) { return NSMakePoint(a.x - b.x, a.y - b.y); }
