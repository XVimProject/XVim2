...
@interface IDEEditorArea : IDEViewController <NSTouchBarProvider, NSTouchBarDelegate, IDEDebuggerBarEditorInfoProvider, IDEEditorMultipleSplitDelegate>
{
    ...
    BOOL _isDeferingJumpBarLayout;
    BOOL _isRunningDeferredJumpBarLayout;
...
+ (void)deferJumpBarLayoutForEditorArea:(id)arg1 duringBlock:(CDUnknownBlockType)arg2;
...
@property(readonly) BOOL isRunningDeferredJumpBarLayout; // @synthesize isRunningDeferredJumpBarLayout=_isRunningDeferredJumpBarLayout;
@property(readonly) BOOL isDeferingJumpBarLayout; // @synthesize isDeferingJumpBarLayout=_isDeferingJumpBarLayout;
...
//- (void).cxx_destruct;
- (void)deferJumpBarLayoutDuringBlock:(CDUnknownBlockType)arg1;
