...
@class DVTDeveloperModeAlertHelper, DVTObservingToken, IDEEnableUITestingAccessViewController, IDELicenseAgreementViewController, IDEPackageInstallerViewController, IDEWelcomeWindowTransitionHelper, NSImageView, NSView;
