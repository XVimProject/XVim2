...
@interface IDEActivityViewDataSource : NSObject <DVTInvalidation>
{
    ...
    NSMutableSet *_hiddenIssueCategories;
...
- (BOOL)_isIssueCategoryHidden:(id)arg1;
- (void)_hideIssueCategories:(id)arg1;
- (id)_visibleIssueCategories;
- (void)_hideIssueCategoriesIfNecessary;
- (id)_defaultIssueCategories;
