...
@class DVTNotificationToken, DVTPathControl, IDENavigableItem, IDENavigableItemCoordinator, IDESchemeManagerNavigable, IDEWorkspace, IDEWorkspaceTabController, NSLayoutConstraint, NSString, NSToolbarItem;
...
@interface IDESchemeToolbarController : DVTToolbarViewController <NSPathControlDelegate, DVTPathCellDelegate, NSMenuDelegate>
{
    ...
    NSLayoutConstraint *_pathControlWidthConstraint;
    NSLayoutConstraint *_pathControlHeightConstraint;
