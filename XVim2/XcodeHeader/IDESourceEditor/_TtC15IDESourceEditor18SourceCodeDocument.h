...
@class DVTSourceCodeLanguage, IDEMediaResourceVariantContext, NSArray, NSDictionary, NSPrintInfo, NSString, NSURL, _TtC15DVTSourceEditor23DVTSourceEditorLandmark, _TtC18SourceModelSupport26SourceModelLanguageService;

@interface _TtC15IDESourceEditor18SourceCodeDocument : IDEEditorDocument <IDESourceCodeGenerationDestination, DVTSourceLanguagePrimaryCompletionStrategy, IDEDocumentStructureProviding, IDESourceCodeDocument, IDEIndexCompatibleDocumentLocationConverter, DVTTextFindable, IDEMediaLibraryDelegate>
{
