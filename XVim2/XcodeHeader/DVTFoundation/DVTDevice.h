...
- (id)startODRAssetServiceForAppAtPath:(id)arg1 runsOnProxy:(BOOL)arg2;
- (id)_bestServerConnectionForCapability:(id)arg1 minimumVersion:(int)arg2 runsOnProxy:(BOOL)arg3;
- (id)handleStoreKitConfigurationSyncForBundleID:(id)arg1 configurationFilePath:(id)arg2 runsOnProxy:(BOOL)arg3;
