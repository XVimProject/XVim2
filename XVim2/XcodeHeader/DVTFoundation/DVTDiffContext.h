...
@class DVTDiffDataSource, DVTDispatchLock, DVTObservingToken, DVTStackBacktrace, NSArray, NSIndexSet, NSMutableArray, NSOperationQueue, NSString;
...
@interface DVTDiffContext : NSObject <DVTFineGrainDiffObserver, DVTInvalidation>
{
    ...
    DVTDispatchLock *_descriptorReadWriteLock;
...
- (BOOL)_cancelledOperationExistsForStartLine:(unsigned long long)arg1;
...
- (void)insertedTextAtStartLine:(long long)arg1 endLine:(long long)arg2 range:(struct _NSRange)arg3;
